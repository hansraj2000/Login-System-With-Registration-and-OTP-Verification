...
class Register:
    def __init__(self,root):
        ...
        #### FG Image ####
        self.left=ImageTk.PhotoImage(file="images/fg1.jpg")
        ...
        title=Label(frame1,text="SIGN-UP HERE",font=("times new roman",20,"bold"),bg="white",fg="green").place(x=50,y=30)
        ###-------------Row 1
        f_name=Label(frame1,text="First Name",font=("times new roman",15,"bold"),bg="white",fg="grey").place(x=50,y=100)
        self.txt_fname=Entry(frame1,font=("times new roman",14),bg="lightgrey",fg="black")
        self.txt_fname.place(x=50,y=130,width=250)

        l_name=Label(frame1,text="Last Name",font=("times new roman",15,"bold"),bg="white",fg="grey").place(x=370,y=100)
        self.txt_lname=Entry(frame1,font=("times new roman",14),bg="lightgrey",fg="black")
        self.txt_lname.place(x=370,y=130,width=250)
        ###-------------Row 2
        contact=Label(frame1,text="Contact No.",font=("times new roman",15,"bold"),bg="white",fg="grey").place(x=50,y=170)
        self.txt_contact=Entry(frame1,font=("times new roman",14),bg="lightgrey",fg="black")
        self.txt_contact.place(x=50,y=200,width=250)

        eamil=Label(frame1,text="E-mail",font=("times new roman",15,"bold"),bg="white",fg="grey").place(x=370,y=170)
        self.txt_email=Entry(frame1,font=("times new roman",14),bg="lightgrey",fg="black")
        ...
        self.txt_answer=Entry(frame1,font=("times new roman",14),bg="lightgrey",fg="black")
        self.txt_answer.place(x=370,y=270,width=250)
        ###-------------Row 4 
        password=Label(frame1,text="Password",font=("times new roman",15,"bold"),bg="white",fg="grey").place(x=50,y=310)
        self.txt_password=Entry(frame1,font=("times new roman",14),bg="lightgrey",fg="black")
        self.txt_password.place(x=50,y=340,width=250)

        cpassword=Label(frame1,text="Confirm Password",font=("times new roman",15,"bold"),bg="white",fg="grey").place(x=370,y=310)
        self.txt_cpassword=Entry(frame1,font=("times new roman",14),bg="lightgrey",fg="black")
        ...
        self.btn_img=ImageTk.PhotoImage(file="images/signup.png")
        btn_register=Button(frame1,image=self.btn_img,bd=0,cursor="hand2",command=self.register_data).place(x=50,y=420)

        # self.btn_img2=ImageTk.PhotoImage(file="images/signin.png")
        # Btn_login=Button(self.root,image=self.btn_img2,bd=0,cursor="hand2").place(x=200,y=530)
        Btn_login=Button(self.root,text="Sign In",command=self.login_window,font=("times new roman",20),bg="lightgreen",bd=0,cursor="hand2").place(x=180,y=530,width=200)
    ...
    def register_data(self):
        if self.txt_fname.get()=="" or self.txt_lname.get()=="" or self.txt_contact.get()=="" or self.txt_email.get()=="" or self.cmb_quest.get()=="Select" or self.txt_answer.get()=="" :
            ...
            messagebox.showerror("Password Error","Password and Confirm Password should be same",parent=self.root)
            ...
            try:
                ...
                if row !=None:
                    ...
                    con.commit()
                    con.close()
                    messagebox.showinfo("Success","Sign up successful, Please SignIn and Verify youreelf",parent=self.root)
                    self.clear()
